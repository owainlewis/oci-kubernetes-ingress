...
// 	ListIngress(ctx context.Context, key string) ([]*extensions.Ingress, error)
// }
...
// func (s kubernetesStore) ListIngress(ctx context.Context, key string) ([]*extensions.Ingress, error) {
